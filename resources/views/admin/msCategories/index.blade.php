...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('cruds.msCategory.title_singular') }} {{ trans('global.list') }}
        </div>

        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-MsCategory">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach ($msCategories as $key => $msCategory)
                            <tr data-entry-id="{{ $msCategory->id }}">
                                <td>
                                ...
                                <td>
                                    ...
                                    @can('ms_category_delete')
                                        <form action="{{ route('admin.ms-categories.destroy', $msCategory->id) }}"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-MsCategory:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
