        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.provinsis.update', [$provinsi->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('nama_provinsi') ? 'is-invalid' : '' }}" type="text"
                        name="nama_provinsi" id="nama_provinsi" value="{{ old('nama_provinsi', $provinsi->nama_provinsi) }}"
                        required>
