...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.klasifikasi.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route('admin.klasifikasis.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('klasifikasi') ? 'is-invalid' : '' }}" type="text"
                        name="klasifikasi" id="klasifikasi" value="{{ old('klasifikasi', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('kode_subkategori') ? 'is-invalid' : '' }}" type="text"
                        name="kode_subkategori" id="kode_subkategori" value="{{ old('kode_subkategori', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('subkategori') ? 'is-invalid' : '' }}" type="text"
                        name="subkategori" id="subkategori" value="{{ old('subkategori', '') }}">
