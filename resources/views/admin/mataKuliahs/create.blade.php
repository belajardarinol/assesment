...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.mata-kuliahs.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('jumlah_pertemuan') ? 'is-invalid' : '' }}" type="number"
                        name="jumlah_pertemuan" id="jumlah_pertemuan" value="{{ old('jumlah_pertemuan', '') }}"
                        step="1">
