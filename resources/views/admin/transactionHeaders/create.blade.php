...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.transactionHeader.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route('admin.transaction-headers.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('rate_euro') ? 'is-invalid' : '' }}" type="number"
                        name="rate_euro" id="rate_euro" value="{{ old('rate_euro', '') }}" step="0.01">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('date_paid') ? 'is-invalid' : '' }}" type="text"
                        name="date_paid" id="date_paid" value="{{ old('date_paid') }}" required>
