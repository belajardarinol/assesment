...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table
                class=" table table-bordered table-striped table-hover datatable datatable-transactionTransactionDetails">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach ($transactionDetails as $key => $transactionDetail)
                        <tr data-entry-id="{{ $transactionDetail->id }}">
                            ...
                            <td>
                                @foreach ($transactionDetail->transactions as $key => $item)
                            ...
                            <td>
                                ...
                                @can('transaction_detail_delete')
                                    <form action="{{ route('admin.transaction-details.destroy', $transactionDetail->id) }}"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-transactionTransactionDetails:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
