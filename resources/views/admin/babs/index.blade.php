...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('cruds.bab.title_singular') }} {{ trans('global.list') }}
        </div>

        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-Bab">
                    <thead>
                        <tr>
                            <th width="10">
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-Bab:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
