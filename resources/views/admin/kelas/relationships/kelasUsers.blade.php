@can('user_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="rounded-pill btn btn-success" href="{{ route('admin.users.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-kelasUsers">
                <thead>
                    <tr>
                        <th width="10">
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-kelasUsers:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
