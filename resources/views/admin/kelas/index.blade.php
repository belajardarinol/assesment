    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-Kela">
                    <thead>
                        <tr>
                            <th width="10">
                        ...
                        @foreach ($kelas as $key => $kela)
                            <tr data-entry-id="{{ $kela->id }}">
                                ...
                                <td>
                                    ...
                                    @can('kela_delete')
                                        <form action="{{ route('admin.kelas.destroy', $kela->id) }}" method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-Kela:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
