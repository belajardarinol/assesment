...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('cruds.cpl.title_singular') }} {{ trans('global.list') }}
        </div>

        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-Cpl">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach ($cpls as $key => $cpl)
                            <tr data-entry-id="{{ $cpl->id }}">
                                <td>
                                ...
                                <td>
                                    ...
                                    @can('cpl_delete')
                                        <form action="{{ route('admin.cpls.destroy', $cpl->id) }}" method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-Cpl:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
